 ...
 */
package io.protonaut.protocols.client.diameter;
...
import io.protonaut.core.message.api.IMessageDecoder;

/**
 * @author Arpan Mukhopadhyay<arixion@outlook.com>
 *
 */
public class DiameterMessageDecoder extends ByteToMessageDecoder implements IMessageDecoder {
